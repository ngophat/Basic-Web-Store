...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 02, 2018 at 06:12 PM
...
('D001', '2017-10-01', 'kh001', 1480000),
('D002', '2017-10-02', 'kh002', 1656000),
('D003', '2017-10-03', 'kh003', 2484500),
('D004', '2017-10-04', 'kh002', 5573000);
...
('001', 'Phat', 0, '123 ly thuong kiet', '089258349', 'h.phatngo@gmail.com'),
...
--
ALTER TABLE `ct_hoadon`
  ADD CONSTRAINT `ct_hoadon_ibfk_1` FOREIGN KEY (`So_hoa_don`) REFERENCES `hoa_don` (`So_hoa_don`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `ct_hoadon_ibfk_2` FOREIGN KEY (`Ma_sua`) REFERENCES `sua` (`Ma_sua`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `hoa_don`
--
ALTER TABLE `hoa_don`
  ADD CONSTRAINT `fk_hoadon_khachhang` FOREIGN KEY (`Ma_khach_hang`) REFERENCES `khach_hang` (`Ma_khach_hang`);

--
-- Constraints for table `sua`
--
ALTER TABLE `sua`
  ADD CONSTRAINT `sua_ibfk_1` FOREIGN KEY (`Ma_hang_sua`) REFERENCES `hang_sua` (`Ma_hang_sua`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `sua_ibfk_2` FOREIGN KEY (`Ma_loai_sua`) REFERENCES `loai_sua` (`Ma_loai_sua`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
